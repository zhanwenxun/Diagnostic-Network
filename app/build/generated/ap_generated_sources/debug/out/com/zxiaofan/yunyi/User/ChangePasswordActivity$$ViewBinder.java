...
public class ChangePasswordActivity$$ViewBinder<T extends com.zxiaofan.yunyi.User.ChangePasswordActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131230872, "field 'etAccount'");
    target.etAccount = finder.castView(view, 2131230872, "field 'etAccount'");
    view = finder.findRequiredView(source, 2131230875, "field 'etPwd'");
    target.etPwd = finder.castView(view, 2131230875, "field 'etPwd'");
    view = finder.findRequiredView(source, 2131230876, "field 'etPwd1'");
    target.etPwd1 = finder.castView(view, 2131230876, "field 'etPwd1'");
