...
public class EditUserActivity$$ViewBinder<T extends com.zxiaofan.yunyi.User.EditUserActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131230859, "field 'ed3'");
    target.ed3 = finder.castView(view, 2131230859, "field 'ed3'");
    ...
    view = finder.findRequiredView(source, 2131230779, "field 'btnDel'");
    target.btnDel = finder.castView(view, 2131230779, "field 'btnDel'");
  }
